"""
Training file for the second half of LEQWENDY method
"""
from models import Leqwendy_second_half
...
def load_data(start, end): # load covariance and A_1
    ...
    for i in data_ranges:
        ...
        xA_file = os.path.join(data_folder, f'dataset_{ds_num}_leqwendyA.npy')
...
model = Leqwendy_second_half().to(device)
...
val_QA = np.load('training_data/dataset_val_leqwendyA.npy')
...
torch.save(model.state_dict(), "weights/leqwendy_2nd.pth")
